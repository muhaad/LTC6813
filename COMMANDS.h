...
//#define ADCV     0b0000001001100000      //Start Start Cell Voltage ADC Conversion and Poll Status (normal ADC conversion rate)
#define ADCV     0b0000001111100000      //Start Start Cell Voltage ADC Conversion and Poll Status (Filtered ADC Conversion Rate)
